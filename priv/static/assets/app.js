  ...
  var require_sortable = __commonJS({
    "vendor/sortable.js"(exports, module) {
      !function(t, e) {
        ...
        function x() {
          ...
          return { captureAnimationState: function() {
            o2 = [], this.options.animation && [].slice.call(this.el.children).forEach(function(t2) {
              var e3, n2;
              P(t2, "display") !== "none" && t2 !== Bt.ghost && (o2.push({ target: t2, rect: k(t2) }), e3 = M({}, o2[o2.length - 1].rect), !t2.thisAnimationDuration || (n2 = v(t2, true)) && (e3.top -= n2.f, e3.left -= n2.e), t2.fromRect = e3);
            });
        ...
        var q, V, Z, $, Q, J, tt, et, nt, ot, it, rt, at, lt, st, ct, ut, dt, ht, ft, pt, gt, mt, vt, bt, yt = false, wt = false, Et = [], Dt = false, St = false, _t = [], Ct = false, Tt = [], xt = typeof document != "undefined", Ot = n, At = w || y ? "cssFloat" : "float", Mt = xt && !c && !n && "draggable" in document.createElement("div"), Nt = function() {
          if (xt) {
            if (y)
              return false;
        ...
        Bt.prototype = { constructor: Bt, _isOutsideThisEl: function(t2) {
          ...
          if (!Ct) {
            ...
            if (wt = false, c2 && !e2.disabled && (u2 ? d2 || (i2 = V !== $) : lt === this || (this.lastPutMode = at.checkPull(this, c2, q, n2)) && s2.checkPut(this, c2, q, n2))) {
              ...
              if (!g2 || function(t3, e3, n3) {
                ...
                if (gt !== l2 && (b2 = w2[S2], Dt = false, St = !D2 && e2.invertSwap || E2), (v2 = function(t3, e3, n3, o3, i3, r3, a3, l3) {
                  ...
                  return 0;
                }(n2, l2, w2, r2, D2 ? 1 : e2.swapThreshold, e2.invertedSwapThreshold == null ? e2.swapThreshold : e2.invertedSwapThreshold, St, gt === l2)) !== 0)
                  for (var _2 = B(q); (y2 = V.children[_2 -= v2]) && (P(y2, "display") === "none" || y2 === Z); )
                    ;
                if (v2 === 0 || y2 === l2)
                  return O2(false);
                mt = v2;
                var C2 = (gt = l2).nextElementSibling, E2 = false, D2 = Ft($, a2, q, o2, l2, w2, n2, E2 = v2 === 1);
                if (D2 !== false)
                  return D2 !== 1 && D2 !== -1 || (E2 = D2 === 1), Ct = true, setTimeout(Ht, 30), x2(), E2 && !C2 ? a2.appendChild(q) : l2.parentNode.insertBefore(q, E2 ? C2 : l2), g2 && F(g2, 0, m2 - g2.scrollTop), V = q.parentNode, b2 === void 0 || St || (vt = Math.abs(b2 - k(l2)[S2])), A2(), O2(true);
              }
              if (a2.contains(q))
                return O2(false);
            }
          ...
          t2.lastPutMode === "clone" ? et && (z("showClone", this), Bt.eventCanceled || (q.parentNode != $ || this.options.group.revertClone ? Q ? $.insertBefore(tt, Q) : $.appendChild(tt) : $.insertBefore(tt, q), this.options.group.revertClone && this.animate(q, tt), P(tt, "display", ""), et = false)) : this._hideClone();
        ...
        var te, ee = S(function(n2, t2, e2, o2) {
          if (t2.scroll) {
            ...
            var d2 = 0, h2 = Wt;
            do {
              var f2 = h2, p2 = k(f2), g2 = p2.top, m2 = p2.bottom, v2 = p2.left, b2 = p2.right, y2 = p2.width, w2 = p2.height, E2 = void 0, D2 = void 0, S2 = f2.scrollWidth, _2 = f2.scrollHeight, C2 = P(f2), T2 = f2.scrollLeft, p2 = f2.scrollTop, D2 = f2 === c2 ? (E2 = y2 < S2 && (C2.overflowX === "auto" || C2.overflowX === "scroll" || C2.overflowX === "visible"), w2 < _2 && (C2.overflowY === "auto" || C2.overflowY === "scroll" || C2.overflowY === "visible")) : (E2 = y2 < S2 && (C2.overflowX === "auto" || C2.overflowX === "scroll"), w2 < _2 && (C2.overflowY === "auto" || C2.overflowY === "scroll")), T2 = E2 && (Math.abs(b2 - r2) <= l2 && T2 + y2 < S2) - (Math.abs(v2 - r2) <= l2 && !!T2), p2 = D2 && (Math.abs(m2 - a2) <= l2 && p2 + w2 < _2) - (Math.abs(g2 - a2) <= l2 && !!p2);
              if (!Zt[d2])
...
`, template.innerHTML.trim());
  ...
  var import_sortable = __toModule(require_sortable());
  var nowSeconds = () => Math.round(Date.now() / 1e3);
  var rand = (min, max) => Math.floor(Math.random() * (max - min) + min);
  var isVisible = (el) => !!(el.offsetWidth || el.offsetHeight || el.getClientRects().length > 0);
  var execJS = (selector, attr) => {
    document.querySelectorAll(selector).forEach((el) => liveSocket.execJS(el, el.getAttribute(attr)));
  };
  var Hooks2 = {};
  Hooks2.Sortable = {
    mounted() {
      let sorter = new import_sortable.default(this.el, {
        animation: 150,
        onEnd: (e) => {
  ...
  Hooks2.Flash = {
    mounted() {
      ...
      this.timer = setTimeout(() => hide(), 8e3);
  ...
  Hooks2.Menu = {
    ...
    menuItems() {
      return Array.from(this.menuItemsContainer.querySelectorAll("[role=menuitem]"));
    },
    onKeyDown(e) {
      if (e.key === "Escape") {
        document.body.click();
  ...
  Hooks2.AudioPlayer = {
    ...
    formatTime(seconds) {
      return new Date(1e3 * seconds).toISOString().substr(14, 5);
    }
  };
  Hooks2.Ping = {
    mounted() {
  ...
  import_topbar.default.config({ barColors: { 0: "rgba(147, 51, 234, 1)" }, shadowColor: "rgba(0, 0, 0, .3)" });
